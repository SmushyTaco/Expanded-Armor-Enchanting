...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        file.displayName = "[${libs.versions.minecraft.get()}] Expanded Armor Enchanting"
...
modrinth {
    ...
    projectId = "expanded-armor-enchanting"
    uploadFile.set(tasks.remapJar)
    gameVersions.add(libs.versions.minecraft)
    versionName = libs.versions.minecraft.map { "[$it] Expanded Armor Enchanting" }
    dependencies {
