...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(486303, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] Expanded Armor Enchanting"
...
modrinth {
    ...
    projectId.set("expanded-armor-enchanting")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Expanded Armor Enchanting")
    dependencies {
